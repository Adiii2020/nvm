...
module.exports = {
  ...
  execute: async (client, message, args, emoji) => {
    ...
    const embed = new client.embed()
      ...
      .setDescription(`<:Bell:1308507329116770365> **Hey MeowMeow here preseting you the best quality music bot which you can experience by using my prefix ! and !help for more info.<:VSCODE:1308552902939381771>
...
let desc = allCmds.join("\n");
    ...
    let menu = new StringSelectMenuBuilder()
      ...
      .setMinValues(1)
      .setMaxValues(1)
      .setPlaceholder("MeowMeow | Select Any")
      .addOptions([
        {
